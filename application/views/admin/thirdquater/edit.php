	...
	<div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-2">
		<div class="widget-box widget-color-blue" id="widget-box-2">
			<div class="widget-header">
				<h5 class="widget-title bigger lighter"> <i class="ace-icon fa fa-cloud-upload"></i> Edit Third Quater File </h5>
			</div>

			<div class="widget-body">
				<div class="widget-main">
					<form id="myForm" action="<?php echo base_url() . 'thirdquater/update/'; ?>" class="form-horizontal" method="post" enctype="multipart/form-data">   
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="year" value="<?php echo $edit->year; ?>" class="col-xs-10 col-sm-5" />
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								...
								<span class="error"> Image (2210x3017) </span>
							</div>
						</div>
