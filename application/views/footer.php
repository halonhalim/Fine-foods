<section class="footer-top">
	<div class="container">
    	<div class="col-md-4 col-sm-4 col-xs-12">
         ...
         <div class="col-md-4 col-sm-4 col-xs-12">
            <h3>Contact Us</h3>
            <p><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $contact->company_name; ?></p>
            <p><i class="fa fa-phone" aria-hidden="true"></i> <?php echo $contact->mobile_no; ?></p>
            <p><i class="fa fa-envelope" aria-hidden="true"></i> <?php echo $contact->email; ?></p>
         </div>
         <div class="col-md-4 col-sm-4 col-xs-12">
            <h3>Location</h3>
            <div class="map">
                <iframe src="<?php echo $contact->google_map;?>" style="border:0" allowfullscreen="" width="100%" height="125" frameborder="0"></iframe>
            </div>
        </div>
    </div>
</section>
